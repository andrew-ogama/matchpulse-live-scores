...
7. Open `admin.html`. If the PHP backend is reachable, the News & Articles panel will show **Backend Login**. Log in with the admin email/password to save articles into MySQL.
